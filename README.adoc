...
| 1    | link:src/mesAlgos/simplicitemeilleur.java[simplicite-meilleur]| Java       | Simplicité | Meilleur
| 2    | link:src/mesAlgos/simplicitepire.java[simplicite-pire]        | Java       | Simplicité | Pire
| 1    | link:src/mesAlgos/simplicitemeilleur.c[simplicite-meilleur]   | C          | Simplicité | Meilleur
| 2    | link:src/mesAlgos/simplicitepire.c[simplicite-pire]           | C          | Simplicité | Pire
| 5    | link:src/mesAlgos/efficacitemeilleur.java[efficacite-meilleur]| Java       | Efficacité | Meilleur
| 6    | link:src/mesAlgos/efficacitepire.java[efficacite-pire]        | Java       | Efficacité | Pire
| 7    | link:src/mesAlgos/sobrietemeilleur.java[sobriété-meilleur]    | Java       | Sobriété   | Meilleur
| 8    | link:src/mesAlgos/sobrietepire.java[sobriété-pire]            | Java       | Sobriété   | Pire
|==========================================================================
...
- être capable d'exécuter des tests JUnit

=== Reproductibilité

- Pour reproduire nos analyses, pour Codacy :
. Rendez-vous sur le site de Codacy
. Selectionner le repository github contenant les fichiers à tester
. Vous obtiendrez ensuite les résultats pour chaque fichier de test

- Pour JoularJx :
. Suivez le guide d'installation sur le github du projet JoularJx
. Une fois installé, entrer la commande suivante pour tester une classe : java -javaagent:joularjx-$version.jar YourProgramMainClass
. pour tester un Jar : java -javaagent:joularjx-$version.jar -jar yourProgram.jar
. Vous obtiendrez ensuite les résultats pour chaque test

- Pour JArchitect
. Créer un compte et télécharger le logiciel
. Ouvrez le logiciel et importer votre projet
. Une fois le projet créé, jArchitect analysera automatiquement votre code contenu dans le projet et affichera les résultats dans l'interface utilisateur.

=== Références

- link:https://github.com/joular/joularjx[JoularJx (Permet de tester l'efficacité énergetique)]
- link:https://www.codacy.com/[Codacy (Permet de tester la qualité et la lisibilité)] 
- link:https://www.jarchitect.com/[JArchitect (Permet de tester la qualité et la lisibilité)]
